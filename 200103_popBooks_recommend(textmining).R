...
# 1. (ISBN아동_2019년_10-12월_아리랑어린이도서관) 인기 아동도서 상위 10개 수집
...
lib_df = read.csv('data/2019_Dec_SeongbookLibs/아리랑어린이도서관 장서 대출목록 (2019년 12월).csv', stringsAsFactors=F )[c(2, 4, 6, 8, 10, 11, 12)]
...
# # + 결과물 임시 저장
# saveRDS(res_list, '200103_19년12월_아리랑어린이도서관_인기도서 10번 관련도서_키워드+가중치 리스트.rds')
# saveRDS(recommend_list, '200103_19년12월_아리랑어린이도서관_인기도서별 추천도서 리스트.rds')
